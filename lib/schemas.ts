...
const PackingListDetailsSchema = z.object({
    ...
    freightMode: fieldValidators.stringOptional,
    portOfLoading: fieldValidators.stringOptional,
    countryOfOrigin: fieldValidators.stringOptional,
    portOfDischarge: fieldValidators.stringOptional,
    finalDestination: fieldValidators.stringOptional,
    countryOfFinalDestination: fieldValidators.stringOptional,
